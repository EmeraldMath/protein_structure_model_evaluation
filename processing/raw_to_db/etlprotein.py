...
def set_casp_8():
    struct_dir = 's3a://protein-structures/protein_raw_data/casp8_str.txt'
    score_dir = 's3a://protein-structures/protein_raw_data/casp_protein_scores/casp8/'
    native_dir = 's3a://protein-structures/protein_raw_data/native.txt'
    return struct_dir, score_dir, native_dir

def set_casp_9():
    struct_dir = 's3a://protein-structures/protein_raw_data/casp9_str.txt'
    score_dir = 's3a://protein-structures/protein_raw_data/casp_protein_scores/casp9/'
    native_dir = 's3a://protein-structures/protein_raw_data/native.txt'
    return struct_dir, score_dir, native_dir

def set_casp_10():
    struct_dir = 's3a://protein-structures/protein_raw_data/casp10_str.txt'
    score_dir = 's3a://protein-structures/protein_raw_data/casp_protein_scores/casp10/'
    native_dir = 's3a://protein-structures/protein_raw_data/native.txt'
    return struct_dir, score_dir, native_dir

def set_casp_11():
    struct_dir = 's3a://protein-structures/protein_raw_data/casp11_str.txt'
    score_dir = 's3a://protein-structures/protein_raw_data/casp_protein_scores/casp11/'
    native_dir = 's3a://protein-structures/protein_raw_data/native.txt'
    return struct_dir, score_dir, native_dir

def set_casp_12():
    struct_dir = 's3a://protein-structures/protein_raw_data/casp12_str.txt'
    score_dir = 's3a://protein-structures/protein_raw_data/casp_protein_scores/casp12/'
    native_dir = 's3a://protein-structures/protein_raw_data/native.txt'
    return struct_dir, score_dir, native_dir

def set_casp_13():
    struct_dir = 's3a://protein-structures/protein_raw_data/casp13_str.txt'
    score_dir = 's3a://protein-structures/protein_raw_data/casp_protein_scores/casp13/'
    native_dir = 's3a://protein-structures/protein_raw_data/native.txt'
    return struct_dir, score_dir, native_dir
...
def main():
    ...
    #struct_dir, score_dir, native_dir = set_casp_8()
    #struct_dir, score_dir, native_dir = set_casp_9()
    #struct_dir, score_dir, native_dir = set_casp_10()
    #struct_dir, score_dir, native_dir = set_casp_11()
    struct_dir, score_dir, native_dir = set_casp_13()
    ...
    #df = df_join.unionAll(df_native.cache()).withColumn('timestamp', unix_timestamp(lit(timestamp),'yyyy-MM-dd HH:mm:ss').cast("timestamp"))
    df = df_join    
    #df.cache().show()
